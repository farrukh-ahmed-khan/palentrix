...
export function CTAButton({ to, href, children, variant = "teal" }: CTAButtonProps) {
  ...
  const cls = variant === "teal"
    ? `${base} btn-teal`
    : `${base} border border-ink/30 text-ink/80 hover:border-indigo hover:text-indigo hover:bg-indigo/5 hover:shadow-[0_0_0_3px_rgba(11,95,170,0.12)] transition-all duration-300`;
