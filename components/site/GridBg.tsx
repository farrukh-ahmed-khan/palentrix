    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(circle, rgba(120,108,255,0.22) 1px, transparent 1px)",
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "linear-gradient(rgba(50,200,255,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(50,200,255,0.04) 1px, transparent 1px)",
