        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 md:gap-0">
          {stats.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.08}>
              <div className={`text-center md:px-6 ${i > 0 ? "md:border-l border-[rgba(120,108,255,0.3)]" : ""}`}>
                <div className="font-display font-bold text-[56px] md:text-[72px] leading-none text-[#5E46C9]">
